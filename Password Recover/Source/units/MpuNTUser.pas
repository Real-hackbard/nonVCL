...
var
  s, s1                 : string;
resourcestring
  rsERROR_ACCESS_DENIED = 'Access denied';
  rsERROR_INVALID_PARAMETER = 'Invalid parameter';
  rsNERR_InvalidComputer = 'Invalid computer';
  rsNERR_NotPrimary =
    'The operation may only be performed on the domain controller.';
  rsNERR_SpeGroupOp =
    'The operation must not be applied to this group.';
  rsNERR_LastAdmin  =
    'The last administrator account cannot be deleted.';
  rsNERR_BadPassword = 'Ungültiges Passwort';
  rsNERR_PasswordTooShort = 'Password too short';
  rsNERR_UserNotFound = 'Invalid user';
  rsNERR_GroupNotFound = 'Group not found';
  rsERROR_NO_SUCH_MEMBER = 'User does not exist';
  rsERROR_INVALID_MEMBER = 'Invalid account';
  rsERROR_MEMBER_IN_ALIAS = 'User is already a member of this group';
