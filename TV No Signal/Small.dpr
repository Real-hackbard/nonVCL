...
begin
  ...
  if Ticks >= 3000 then begin
    ...
    Ticks := 0;
    case tm of
      1 : NaGText := 'this is an example..';
      2 : NaGText := '- for a nonVCL -';
      3 : NaGText := 'graphic effect..';
      4 : NaGText := 'draw canvas..';
      5 : NaGText := 'on your form..';
      6 : NaGText := 'an old television..';
      7 : NaGText := 'who simply has no..';
      8 : NaGText := 'TV reception.';
      9 : NaGText := ';)';
      10 : NaGText := 'But that doesnt matter, ..';
      11 : NaGText := 'because too..';
      12 : NaGText := 'much TV is..';
      13 : NaGText := 'Unhealthy! :(';
      14 : NaGText := 'Thats why dont ... ';
      15 : NaGText := 'waste your time...';
      16 : NaGText := 'watching too much';
      17 : NaGText := 'TV :)';
      18 : NaGText := 'and visiting';
      19 : NaGText := 'asciigen.blogspot.com';
      20 : begin
            NaGText := 'THE END';
            tm := 0;
           end;
...
if (not InitApplication) then
   MessageBox(0, 'No init', nil, mb_Ok)
else
begin
