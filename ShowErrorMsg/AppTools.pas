...
(****************************************************************
 ...
 (and sometimes even the very last one :o) )
****************************************************************)
var
  LastError: DWORD;
...
begin
  ...
  wvsprintf(szBuffer, 'Win32 error. Code: %d', PChar(@LastError));
...
(****************************************************************
 ...
 Function:
 Displays a message box with its own icon.
****************************************************************)
var
...
(****************************************************************
 function LoadStr
 Return value: String (from Ressource)

 Function:
 Loads the string specified by the ID from the resource.
****************************************************************)
var
